import classes.competencias.Competencias
import classes.vagas.Vagas
import jdbc.bancos.competencias.CompetenciasJDBC
import jdbc.bancos.candidato.CandidatoJDBC
import jdbc.bancos.empresa.EmpresaJDBC
import jdbc.bancos.pais.PaisJDBC
import jdbc.bancos.vagas.VagasJDBC
                ...
                if(regex.regexVerificador.matcher(verificador).matches()){
                    switch (verificador){
                        ...
                        case "3":
                            ...
                            def newCompany = new PessoaJuridica(Long.parseLong(registro), Integer.parseInt(pais), nome, email, descricao, Integer.parseInt(cep), senha)
                        ...
                        case "4":
                            ...
                            def newCandidate = new PessoaFisica(sobrenome, Long.parseLong(registro), nome, email, descricao, Integer.parseInt(cep), data, Integer.parseInt(pais), formacao, senha)
